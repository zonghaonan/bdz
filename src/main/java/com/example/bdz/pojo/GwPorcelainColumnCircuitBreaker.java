...
@ApiModel(value="GwPorcelainColumnCircuitBreaker对象", description="")
public class GwPorcelainColumnCircuitBreaker implements Serializable {
    ...
    @ApiModelProperty(value = "模型名称 瓷柱式断路器")
...
ratedCurrent;
    ...
    private Double distanceOfCircuitBreaker;
    ...
    private String withstandVoltageFracture;

    @ApiModelProperty(value = "额定工频耐受电压（对地）")
    private String withstandVoltageGround;
    ...
    private String openingAndClosingTime;

    @ApiModelProperty(value = "分闸时间")
    private String openingTime;

    @ApiModelProperty(value = "合闸时间")
    private String closingTime;

    @ApiModelProperty(value = "重合闸无电流间隙时间")
    private String reclosingNoCurrentGapTime;

    @ApiModelProperty(value = "分闸不同期性（同相）")
    private String openingAsynchronyInphase;

    @ApiModelProperty(value = "分闸不同期性（同相断口间）")
    private String openingAsynchronyInterphaseFracture;

    @ApiModelProperty(value = "分闸不同期性（相间）")
    private String openingAsynchronyAlternate;

    @ApiModelProperty(value = "分闸不同期性（同相断口间）2")
    private String openingAsynchronyInterphaseFracture2;
...
breakingCurrent;
    ...
    @ApiModelProperty(value = "本体检修周期")
    private String bodyMaintenanceCycle;
