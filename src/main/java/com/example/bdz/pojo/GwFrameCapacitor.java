...
@ApiModel(value="GwFrameCapacitor对象", description="")
public class GwFrameCapacitor implements Serializable {
    ...
    @ApiModelProperty(value = "模型名称 框架式电容器")
    ...
    private Double deviationBetweenCapacitorBankCapacitanceRatedCapacitance;

    @ApiModelProperty(value = "保护方式")
    private String protectionMode;

    @ApiModelProperty(value = "投切方式")
    ...
    @ApiModelProperty(value = "耐爆能量")
    private String explosionResistantEnergy;
