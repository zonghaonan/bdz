...
@ApiModel(value="GwIncomingCabinet对象", description="")
public class GwIncomingCabinet implements Serializable {
    ...
    @ApiModelProperty(value = "模型名称 35kV进线柜")
    ...
    @ApiModelProperty(value = "进线方式")
    private String incomingLineMode;
    ...
    @ApiModelProperty(value = "供电电源（控制回路）")
    private String powerSupplyControlLoop;

    @ApiModelProperty(value = "供电电源（辅助回路）")
    private String powerSupplyAuxiliaryCircuit;
    ...
    @ApiModelProperty(value = "辅助和控制回路短时工频耐受电压")
    private Double withstandVoltageOfAuxiliaryAndControlCircuits;
