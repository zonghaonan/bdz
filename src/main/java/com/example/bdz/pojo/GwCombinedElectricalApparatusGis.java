...
@ApiModel(value="GwCombinedElectricalApparatusGis对象", description="")
public class GwCombinedElectricalApparatusGis implements Serializable {
    ...
    @ApiModelProperty(value = "模型名称 组合电器GIS")
...
ratedCurrentOut;
    ...
    @ApiModelProperty(value = "额定电流（进线）")
    private Double 
ratedCurrentIn;

    @ApiModelProperty(value = "额定电流（主母线）")
    private Double ratedCurrentMain;

    @ApiModelProperty(value = "额定工频1min耐受电压（相对地）")
    private Double withstandVoltage;

    @ApiModelProperty(value = "额定雷电冲击耐受电压峰值（250/2500s，相对地）")
    ...
    private Double shortTimeWithstandVoltageOfAuxiliaryAndControlCircuits;
    ...
    @ApiModelProperty(value = "母线结构布置")
    private String busStructureLayout;
    ...
    @ApiModelProperty(value = "局放（电压互感器）")
    private Double partialReleaseOfVoltageTransformer;

    @ApiModelProperty(value = "局放（避雷器）")
    private Double partialReleaseOfLightningArrester;
